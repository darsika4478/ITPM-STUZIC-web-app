...
import { onAuthStateChanged, createUserWithEmailAndPassword, updateProfile, signInWithPopup, signInWithRedirect, getRedirectResult } from 'firebase/auth';
        ...
        const handleRedirectResult = async () => {
            try {
                ...
                if (error?.code !== 'auth/no-auth-event') {
                    console.error('Google redirect sign-up failed:', error);
                }
            } finally {
        ...
        try {
            ...
            if (error?.code === 'auth/popup-blocked' || error?.code === 'auth/operation-not-supported-in-this-environment') {
                try {
                    ...
                    console.error('Google redirect sign-up failed:', redirectError);
                }
            }
    ...
    return (
        <main style={{
            ...
            <div style={{
                ...
                {/* Close to home button for initial view */}
                {signupMethod === 'choose' && (
                    <button
                        type="button"
